...
type homefooxworkspacenodemultiCountersrccomponentsseoTsx3000541721QueryVariables = Exact<{ [key: string]: never; }>;


type homefooxworkspacenodemultiCountersrccomponentsseoTsx3000541721Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };
